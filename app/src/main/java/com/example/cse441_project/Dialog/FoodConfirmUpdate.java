...
public class FoodConfirmUpdate {
    private Dialog dialog;
    private OnDialogActionListener listener;

    // Constructor nhận context và listener
    public FoodConfirmUpdate(Context context, OnDialogActionListener listener) {
        ...
        // Thiết lập nội dung
        dialogTitle.setText("Cập nhật");
        dialogMessage.setText("Bạn có chắc chắn muốn cập nhật thông tin món ăn?");
